...
; angles per detector
;
sca1_detector_hist = histogram(data.field05[sca1_indices],/L64)
sca2_detector_hist = histogram(data.field05[sca2_indices],/L64)
sca3_detector_hist = histogram(data.field05[sca3_indices],/L64)
